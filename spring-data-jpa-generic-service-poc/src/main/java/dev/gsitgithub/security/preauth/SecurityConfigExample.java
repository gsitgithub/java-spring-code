...
/**
 * The Class SecurityConfig example.
 * https://www.programcreek.com/java-api-examples/?code=psi-probe/psi-probe/psi-probe-master/core/src/main/java/psiprobe/ProbeSecurityConfig.java#
 */
//@Configuration
@EnableWebSecurity
public class SecurityConfigExample extends WebSecurityConfigurerAdapter {
	...
	public FilterChainProxy getFilterChainProxy() {
		SecurityFilterChain chain = new DefaultSecurityFilterChain(new AntPathRequestMatcher("/**"),
				getSecurityContextPersistenceFilter(), getJ2eePreAuthenticatedProcessingFilter(), getLogoutFilter(),
	...
	public FilterSecurityInterceptor getFilterSecurityInterceptor() {
		...
		requestMap.put(new AntPathRequestMatcher("/sql/**"),
				SecurityConfig.createListFromCommaDelimitedString("ROLE_POWERUSERPLUS,ROLE_MANAGER,ROLE_MANAGER-GUI"));
		requestMap.put(new AntPathRequestMatcher("/app/**"), SecurityConfig
				.createListFromCommaDelimitedString("ROLE_POWERUSER,ROLE_POWERUSERPLUS,ROLE_MANAGER,ROLE_MANAGER-GUI"));
		requestMap.put(new AntPathRequestMatcher("/**"), SecurityConfig.createListFromCommaDelimitedString(
