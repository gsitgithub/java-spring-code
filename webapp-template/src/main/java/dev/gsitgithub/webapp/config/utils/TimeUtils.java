...
public class TimeUtils {
	...
	public static String format(long milliSeconds) {
		return DateUtil.ISO8061_FORMATTER
				.format(Instant.ofEpochMilli(milliSeconds).atZone(DateUtil.getDefaultZone()).toLocalTime());
	}

//    public static String format(Period milliSeconds) {
//        return DateUtil.ISO8061_FORMATTER.format(milliSeconds.);
//    }
